...
const easyQuestions = [
    {
        ...
        answers: [
            { text: 'Treaty of Heiligen', correct: false },
            { text: 'Treaty of Verdum', correct: false },
            { text: 'Treaty of Tempe', correct: false },
            { text: 'Treaty of Windsor', correct: true }
        ]
    }, {
        question: 'What type of boats did the Vikings use when exploring and raiding?',
        answers: [
            { text: 'Caravel', correct: false },
            { text: 'longships', correct: true },
            { text: 'Yacht', correct: false },
            { text: 'Balinger Ship', correct: false }
        ]
    }, {
        ...
        answers: [
            { text: '5 May 1789', correct: true },
            { text: '25 April 1974', correct: false },
            { text: '10 June 1856', correct: false },
            { text: '15 September 1639', correct: false }
        ]
    }, {
...
const mediumQuestions = [
    {
        ...
        answers: [
            ...
            { text: 'Public sports', correct: false },
            { text: 'Public baths', correct: true },
        ...
        answers: [
            ...
            { text: 'The Battle for England', correct: false },
            { text: 'The Battle of Antioch', correct: false },
        ...
        answers: [
            ...
            { text: 'Moat', correct: true }
        ]
    }, {
        question: 'What was the name of Nazi Germany\'s official secret police?',
        answers: [
            { text: 'Gendarmerie', correct: false },
            { text: 'Polizei', correct: false },
            { text: 'Gestapo', correct: true },
            { text: 'Carabinieri', correct: false }
        ]
    }, {
        ...
        answers: [
            { text: '1257', correct: false },
            { text: '1760', correct: false },
            { text: '1689', correct: false },
